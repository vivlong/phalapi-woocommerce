...
{
    public function listAllProductVariations(int $productId, array $parameters = []): array
    {
        return $this->request('get', 'products/' . $productId . '/variations', $parameters, true);
    }

    public function retrieveProductVariation(int $productId, int $variationId, array $parameters = []): mixed
    {
        return $this->request('get', 'products/' . $productId . '/variations/' . $variationId, $parameters);
    }

    public function updateProductVariation(int $productId, int $variationId, array $parameters = []): mixed
    {
        return $this->request('post', 'products/' . $productId . '/variations/' . $variationId, $parameters);
    }

    public function createProductVariation(int $productId, array $parameters = []): mixed
    {
        return $this->request('post', 'products/' . $productId . '/variations', $parameters);
    }

    public function deleteProductVariation(int $productId, int $variationId, array $parameters = []): mixed
    {
        return $this->request('delete', 'products/' . $productId . '/variations/' . $variationId, $parameters);
    }

    public function batchProductVariations(int $productId, array $parameters = []): mixed
    {
