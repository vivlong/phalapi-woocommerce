...
{
    public function listAllProductAttributes(array $parameters = []): array
    {
        return $this->request('get', 'products/attributes', $parameters, true);
    }

    public function retrieveProductAttribute(int $id, array $parameters = []): mixed
    {
        return $this->request('get', 'products/attributes/' . $id, $parameters);
    }

    public function updateProductAttribute(int $id, array $parameters = []): mixed
    {
        return $this->request('post', 'products/attributes/' . $id, $parameters);
    }

    public function createProductAttribute(array $parameters = []): mixed
    {
        return $this->request('post', 'products/attributes', $parameters);
    }

    public function deleteProductAttribute(int $id, array $parameters = []): mixed
    {
