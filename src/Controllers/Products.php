...
{
    public function listAllProducts(array $parameters = [])
    {
        return $this->request('get', 'products', $parameters, true);
    }

    public function retrieveProduct(int $id, array $parameters = [])
    {
        return $this->request('get', 'products/'.$id, $parameters);
    }

    public function updateProduct(int $id, array $parameters = [])
    {
    ...
    public function deleteProduct(int $id, array $parameters = [])
    {
        return $this->request('delete', 'products/'.$id, $parameters);
    }

    public function batchProducts(array $parameters = [])
    {
