...
{
    public function listAllCustomers(array $parameters = []): array
    {
        return $this->request('get', 'customers', $parameters, true);
    }

    public function retrieveCustomer(int $id, array $parameters = []): mixed
    {
        return $this->request('get', 'customers/' . $id, $parameters);
    }

    public function updateCustomer(int $id, array $parameters = []): mixed
    {
        return $this->request('post', 'customers/' . $id, $parameters);
    }

    public function createCustomer(array $parameters = []): mixed
    {
        return $this->request('post', 'customers', $parameters);
    }

    public function deleteCustomer(int $id, array $parameters = []): mixed
    {
        return $this->request('delete', 'customers/' . $id, $parameters);
    }

    public function batchCustomers(array $parameters = []): mixed
    {
